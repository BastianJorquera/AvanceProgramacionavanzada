...
public class Main {
    ...
    private static void ingresarDatosEmpleado() {
    ...
    private static boolean procesarOpcionDos(int opcionDos) {
        switch (opcionDos) {
            case 1:
    ...
    private static String obtenerDatoOpcional(String mensaje) {
        System.out.print(mensaje);
        return scanner.nextLine();
    }
    ...
    private static double obtenerSalarioOpcional(String mensaje) {
